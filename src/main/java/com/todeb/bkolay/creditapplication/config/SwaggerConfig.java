package com.todeb.bkolay.creditapplication.config;
...
/**
 * <a href="http://localhost:8080/swagger-ui/index.html">http://localhost:8090/swagger-ui/index.html</a>
 * <a href="http://localhost:8080/swagger-ui/index.html#/">http://localhost:8090/swagger-ui/index.html#/</a>
...
public class SwaggerConfig {
    ...
    public Docket customDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.todeb.bkolay.creditapplication"))
...
//                .paths(PathSelectors.any())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "1",
                "Terms of service",
                new Contact("Burak Kolay", "https://github.com/BurakKolay", "burakkolay487@gmail.com"),
                "License of API",
                "API license URL",
