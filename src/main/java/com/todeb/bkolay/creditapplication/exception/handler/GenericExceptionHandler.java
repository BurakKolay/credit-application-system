package com.todeb.bkolay.creditapplication.exception.handler;
...
public class GenericExceptionHandler {
    ...
    @ExceptionHandler(CreditApplicationException.class)
    public ResponseEntity<Map<String, String>> handleCreditApplicationNotFinishedException(Exception exception){
